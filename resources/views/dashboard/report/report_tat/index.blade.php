                        ...
                        <div class="p-0">
                            ...
                            <div class="py-5">
                                ...
                                <div class="d-flex justify-content-between mb-5">
                                    <div class="col-lg-3">
                                        <button type="button" id="print-report" href="{{url('report/tat-print')}}" class="btn btn-sm btn-light btnPrint">Print Report</button>
                                ...
                                <table class="table gy-1 align-middle table-striped px-0 datatable-ajax" id="datatables">
                                    <thead>
                                        <tr class="text-start text-gray-600 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="text-start" width="10%">Patient Name</th>
                                            <th class="text-start" width="8%">Medrec</th>
                                            <th class="text-start" width="8%">Group Name</th>
                                            <th class="text-start" width="8%">Package Name</th>
                                            <th class="text-start" width="8%">Test Name</th>
                                            <th class="text-start" width="8%">Check In Time</th>
                                            <th class="text-start" width="8%">Draw Time</th>
                                            <th class="text-start" width="8%">Finish Time</th>
                                            <th class="text-start" width="8%">TAT</th>
                                        </tr>
                                    </thead>
