...
<body>
    ...
    <div>
        <h3>LAPORAN TRANSAKSI NOTA LABORATORIUM</h3>
        <table>
            <tr>
        ...
        <table id="tb_result" style="border: 1px solid black; margin: 5px; border-collapse: collapse;">
            <thead>
                <tr>
                    ...
                    <th class="border-bottom" style="text-align: center;">Harga</th>
                </tr>
            </thead>
            <tbody>
                @php
                ...
                <tr>
                    ...
                    <td style="text-align: center; border: 1px solid black; border-collapse: collapse;">
                        <?php
                        if ($data->package_id) {
                            echo number_format($data->package_price, 0, ",", ".");
                        } else {
                            echo number_format($data->test_price, 0, ",", ".");
                        }
                        ?>
                    </td>
                </tr>
