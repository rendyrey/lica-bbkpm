...
<body>
    ...
    <div>
        <h3>LAPORAN PENGULANGAN PEMERIKSAAN LABORATORIUM</h3>
        <table>
            <tr>
        ...
        <table id="tb_result" style="border: 1px solid black; margin: 5px; border-collapse: collapse;">
            <thead>
                <tr>
                    ...
                    <th class="border-bottom" style="text-align: center;">Hasil Pengulangan</th>
                </tr>
            </thead>
            <tbody>
                @php
                ...
                <tr>
                    ...
                    <td style="text-align: center; border: 1px solid black; border-collapse: collapse;">{{ $data->result }}</td>
                    <td style="text-align: center; border: 1px solid black; border-collapse: collapse;">{{ $data->result_duplo }}</td>
                </tr>
                @php
                $index++;
                @endphp
