...
<body>
    ...
    <div>
        <h3>LAPORAN JUMLAH SPECIMEN TINDAKAN LABORATORIUM</h3>
        <table>
            <tr>
        ...
        <table id="tb_result" style="border: 1px solid black; margin: 5px; border-collapse: collapse;">
            <thead>
                <tr>
                    ...
                    <th class="border-bottom" style="text-align: center;">Nama Spesimen</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center; border: 1px solid black; border-collapse: collapse;">{{ $data->specimen_name }}</td>
