        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div style="background-color: #F5F8FA" height="20%" class="header align-items-stretch">
                    ...
                    <div class="container-xxl d-flex align-items-stretch justify-content-between">
                        ...
                        <table style="width: 100%">
                            <tbody>
                                <tr>
                                    <td style="font-size: 20px; text-align: right;" width="20%">
                                        <img src="{{asset('images/logo-bbkpm.png')}}" style="width: 85px; height: 85px;">
                                    </td>
                                    <td style="font-size: 24px; text-align:center; font-weight: bold;" width="60%">
                                        ANTRIAN PEMERIKSAAN LABORATORIUM
                                        <br>
                                        BALAI BESAR KESEHATAN PARU MASYARAKAT BANDUNG
                                    </td>
                                    <td style="font-size: 20p;" width="20%">
                ...
                <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <marquee>
                        <h5 style="color: #000000">LABORATORIUM BALAI BESAR KESEHATAN PARU MASYARAKAT BANDUNG</h5>
                    </marquee>
