                            ...
                            <div class="row mt-2">
                                    ...
                                    <table class="table table-striped transaction-test-table">
                                        ...
                                        <thead>
                                            ...
                                            <tr class="px-0 text-uppercase text-gray-600 fw-bolder fs-7">
                                                <td class="px-0" width="25%">Test</td>
                                                <td class="px-0" width="20%">Result</td>
                                ...
                                <div class="col-4">
                                    <div class="d-flex flex-row">
                                        ...
                                        <?php } ?>
                                        <button class="btn btn-light-info btn-sm test-data-action d-none mx-5 mb-1" id="send-half-data" data-transaction-id="" disabled>Send Data</button>
