    ...
    <div>
        ...
        <table id="tb_result" width="100%" style="border-bottom: 1px solid black">
            <thead>
                <tr>
                    ...
                    <th class="border-bottom" id="content" style="width:2%;"></th>
        ...
        <table id="tb_result" width="100%" style="border-bottom: 1px solid black;">
            ...
            <tr id="content">
                ...
                <!-- td test name -->
                @if ($sub_group == '')
                <td id="content" style="padding-left:25px; padding-bottom: 3px;" valign="top">{{ $test->test_name }}</td>
                @else
                <td id="content" style="padding-left:25px; padding-bottom: 3px;" valign="top">{{ $test->test_name }}</td>
                @endif
                <!-- end td test name -->
        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td style="text-align: left; width: 20%;"> : <?= date('d/m/Y H:i', strtotime($group_draw_time)); ?></td>
        ...
        <table style="position: fixed;">
            <tbody>
                ...
                <tr>
                    <td width="80%" style="text-align: right;"> </td>
                    <td width="20%" style="text-align: center;">{{ $transaction->validator_name }}</td>
                </tr>
