    ...
    <div>
        ...
        <table id="tb_result" width="100%" style="border-bottom: 1px solid black;">
            ...
            <tr id="content">
                ...
                <!-- td test name -->
                @if ($sub_group == '')
                <td id="content" style="padding-left:25px; padding-bottom: 1px;">{{ $test->test_name }}</td>
                @else
                <td id="content" style="padding-left:25px; padding-bottom: 1px;">{{ $test->test_name }}</td>
                @endif
                <!-- end td test name -->
                ...
                <td id="content" style="text-align: center; padding-bottom: 3px;">{{ $test->unit }}</td>
        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td style="text-align: left; width: 20%;"> : <?= date('d/m/Y H:i', strtotime($transaction->checkin_time)); ?></td>
