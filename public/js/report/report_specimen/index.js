...
var DateRangePicker = () => {
  ...
  $("#daterange-picker").on('change', function () {
      ...
      var specimen_id = $("select[name='specimen_id']").val()
      
      const url = baseUrl('report/specimen-datatable/'+startDate+'/'+endDate+'/'+specimen_id);
      Datatable.refreshTableAjax(url);

      $('#print-report').attr("href", baseUrl('report/specimen-print/'+startDate+'/'+endDate+'/'+specimen_id))
  });
...
var Select2ServerSideSpecimen = function (theData, searchKey = 'name') {
...
document.addEventListener('DOMContentLoaded', function () {
  Datatable.init();
  DateRangePicker();
  Select2ServerSideSpecimen('specimen').init();
  $('.btnPrint').printPage();
  $('body').tooltip({
