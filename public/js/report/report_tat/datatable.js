...
var columnsDataTable = [
    ...
    { data: 'patient_name' },
    { data: 'patient_medrec' },
    { data: 'group_name', name: 'finish_transaction_tests.group_name'},
    { data: 'package_name'},
    { data: 'test_name_custom'},
    { data: 'checkin_time', 
        render: function (data, type, row, meta) {
    ...
    { data: 'draw_time', name: 'finish_transaction_tests.draw_time',
        render: function (data, type, row, meta) {
            var draw_time = moment(row.draw_time).format("HH:mm:ss");
            return draw_time;
        }
    },
    ...
    { data: 'patient_medrec', 
        render: function (data, type, row, meta) {
            var checkin_time = row.checkin_time;

            if(row.validate_time){
                var validate_time = row.validate_time;
                var tat_time = moment.utc(moment(validate_time, "YYYY/MM/DD HH:mm:ss").diff(moment(checkin_time, "YYYY/MM/DD HH:mm:ss"))).format("HH:mm:ss");
            }else{
                var validate_time = '-';
                var tat_time = '-';
            }
